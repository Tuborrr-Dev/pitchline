...
function MarketRow({ row }: { row: MarketOverviewRow }) {
  ...
  return (
    <div className="grid min-w-[56rem] grid-cols-[8.5rem_17rem_8rem_1fr_5.5rem] items-center border-t border-[var(--terminal-line)] px-4 py-3 text-[var(--foreground)] transition hover:bg-[var(--terminal-hover)]">
...
function MarketCompactListRow({ row }: { row: MarketOverviewRow }) {
  ...
  return (
    <div className="border-t border-[var(--terminal-line)] px-4 py-4 transition hover:bg-[var(--terminal-hover)]">
...
export function MarketTable({ rows }: { rows: MarketOverviewRow[] }) {
  return (
    <div>
      <div className="grid min-w-[56rem] grid-cols-[8.5rem_17rem_8rem_1fr_5.5rem] items-center border-b border-[var(--terminal-border)] bg-[var(--terminal-surface)] px-4 py-3 font-mono text-[0.68rem] font-semibold uppercase text-[var(--terminal-text-muted)]">
        <div>Status</div>
        <div>Event / Pair</div>
